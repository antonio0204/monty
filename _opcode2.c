...
/**
 * _mul - A function that multiply the two top values of a stack.
...
/**
 * _div - A function that divides the second value from the top of a
...
/**
 * _mod - A function that modules the second value from the top of a
 * stack linked by the top value.
 * @stack: The pointer to the stack list.
 * @line_number: The line number of a Monty bytecodes file.
 * Description: The result is stored in the second node
...
/**
 * _pchar - A function that prints char at top value of the stack.
 * @stack: The pointer to the stack list.
...
/**
 * _pstr - A function that prints the string starting at the top of the
